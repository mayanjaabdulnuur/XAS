...
// Never statically prerendered — this reads the current session and the
// database on every request. Explicit, rather than relying solely on
// Next.js's automatic detection of cookies()/headers() usage inside
// getCurrentUser().
      ...
      <main className="max-w-5xl mx-auto px-4 py-8">
        ...
        {subjects.length === 0 ? (
          <p className="text-white/50 text-sm">
            No A Level subjects yet — an administrator hasn&apos;t added any. Run{" "}
